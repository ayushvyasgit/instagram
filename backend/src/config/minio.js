...
export const uploadService = {
  async uploadFile(file, userId, folder = 'posts') {
    ...
    const url = `http://${config.MINIO_ENDPOINT}:${config.MINIO_PORT}/${config.MINIO_BUCKET}/${fileName}`;
  ...
  async getFileUrl(fileName) {
    return `http://${config.MINIO_ENDPOINT}:${config.MINIO_PORT}/${config.MINIO_BUCKET}/${fileName}`;
  },
};
